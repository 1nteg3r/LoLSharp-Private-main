...
ImDrawList* ImGui::GetImguigroundDrawList()
{
	return &GImGui->ImguigroundDrawList;
}
...
ImDrawList* ImGui::GetTestgroundDrawList()
{
	return &GImGui->TestgroundDrawList;
}
...
void ImGui::NewFrame()
{
	...
	g.ImguigroundDrawList.Clear();
	g.ImguigroundDrawList.PushTextureID(g.IO.Fonts->TexID);
	g.ImguigroundDrawList.PushClipRectFullScreen();

    g.ForegroundDrawList.Clear();
    g.ForegroundDrawList.PushTextureID(g.IO.Fonts->TexID);
    g.ForegroundDrawList.PushClipRectFullScreen();

	g.TestgroundDrawList.Clear();
	g.TestgroundDrawList.PushTextureID(g.IO.Fonts->TexID);
	g.TestgroundDrawList.PushClipRectFullScreen();
...
void ImGui::Shutdown(ImGuiContext* context)
{
	...
	g.ImguigroundDrawList.ClearFreeMemory();
	g.ForegroundDrawList.ClearFreeMemory();
	g.TestgroundDrawList.ClearFreeMemory();
...
void ImGui::Render()
{
	...
	if (!g.ImguigroundDrawList.VtxBuffer.empty())
		AddDrawListToDrawData(&g.DrawDataBuilder.Layers[0], &g.ImguigroundDrawList);

    if (!g.ForegroundDrawList.VtxBuffer.empty())
        AddDrawListToDrawData(&g.DrawDataBuilder.Layers[0], &g.ForegroundDrawList);

	if (!g.TestgroundDrawList.VtxBuffer.empty())
		AddDrawListToDrawData(&g.DrawDataBuilder.Layers[0],&g.TestgroundDrawList);
