...
namespace ImGui
{
	...
	IMGUI_API void          ProgressBar(float fraction, const ImVec2& size_arg = ImVec2(-1, 0), const char* overlay = NULL, const ImU32& bg_col = 0, const ImU32& fg_col = 0);
	IMGUI_API void			Spinner(const char* label, float radius, int thickness, const ImU32& color = 0);
	...
	IMGUI_API ImDrawList*   GetImguigroundDrawList();
	IMGUI_API ImDrawList*   GetForegroundDrawList();                                            // this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear imgui contents.
	IMGUI_API ImDrawList*   GetTestgroundDrawList();
