...
local core = module.load("int", "Core/Teemo/core")
local q = module.load("int", "Core/Teemo/spells/q")
local w = module.load("int", "Core/Teemo/spells/w")
local e = module.load("int", "Core/Teemo/spells/e")
local r = module.load("int", "Core/Teemo/spells/r")
