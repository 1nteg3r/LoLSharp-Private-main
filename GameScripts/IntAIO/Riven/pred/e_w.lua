...
local w = module.load("int", "Core/Riven/spell/w");--require'Core/Riven/spell/w'
local e = module.load("int", "Core/Riven/spell/e");--require'Core/Riven/spell/e'
local push = module.load("int", "Core/Riven/pred/push");--require'Core/Riven/pred/push'
