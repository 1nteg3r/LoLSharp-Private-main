local menu = menu("MarksmanAIOKennen", "Marksman - Kennen")

menu:header('header_combo', 'Combo Mode')
menu:boolean('combo_q', 'Use Q', true)
menu:dropdown('combo_w', 'Use W', 2, { 'Never', 'Stun Only', 'Always' })
...
menu:dropdown('harass_w', 'Use W', 2, { 'Never', 'Stun Only', 'Always' })
