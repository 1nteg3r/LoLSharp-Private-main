...
private:
	NewMenu(const char* name, const char* displayName);
	~NewMenu();
...
public:
	...
	static std::vector<NewMenu*> RootMenus;
	...
	static NewMenu* CreateMenu(const char* name, const char* displayName);

	std::vector<NewMenu*> Children;
	std::vector<MenuComponent*> Components;

	NewMenu* AddMenu(const char* name, const char* displayName);
