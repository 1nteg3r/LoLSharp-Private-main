...
enum class SkinHash : unsigned int
{
	Aatrox = 0x71097207,
	Ahri = 0xD4BD813E,
	Akali = 0x5F193A14,
	...
	SRU_Krug = 0xA20205E2,
	SRU_KrugMedium = 0xF8123C99,
	SRU_KrugSmall = 0xA8245C50,
	SRU_Murkwolf = 0x621947DC,
	SRU_Razorbeak = 0x244E9932,
	SRU_RazorbeakSmall = 0xA2C97FE9,
	SRU_Blue = 0xFC505223,
	SRU_Red = 0x9CA35508,
	...
	Teemo_Trap = 0x2b2ff5ae,
	Caitlyn_Trap = 0xAACC89a5,
	Jhin_Trap = 0x1c23c910,
	Jinx_Trap = 0xbe57163c,
	Nidalee_Trap = 0x135ae185,
	Shaco_Trap = 0x4ac2e173,
	Veigo = 0x9662A07A,
};
...
public:
	...
	MAKE_DATA(DWORD, GetSkinName, 0x4);
	MAKE_DATA(SkinHash, GetSkinHash, 0x10);
	MAKE_DATA(DWORD, GetProperties, 0x1C);
